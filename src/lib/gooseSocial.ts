...
const ONELINER_DIALOGUES: string[][] = [
  ...
  ["Quacktro loading.", "Rasterbars warming up."],
  ["SID humming today?", "Always at 6581 glory."],
  ["Got scrolltext?", "Got infinite scrolltext."],
  ["Copperlist ready?", "Copperlist hungry."],
  ["Demo mood?", "Demo mode!"],
  ["VBlank soon?", "Never soon enough."],
  ["Where's the coder?", "Still optimizing."],
  ["Where's the musician?", "Still pattern-jamming."],
  ["Where's the graphician?", "Still dithering."],
  ["Party time?", "Party hard!"],
  ["Got beer?", "Got compo beer."],
  ["Got deadlines?", "Missed them already."],
  ["Releasing tonight?", "If it boots."],
  ["Boot error?", "Feature."],
  ["More effects?", "More hacks."],
  ["More hacks?", "More glory."],
  ["More glory?", "More goose."],
  ["Trackmo?", "Crackmo!"],
  ["Oldschool?", "Forever."],
  ["Newschool?", "Shader-powered."],
  ["Shader crash?", "Driver fault."],
  ["Driver fault?", "Coder fault."],
  ["Coder fault?", "Never!"],
  ["SID or Paula?", "Both, quack."],
  ["YM2149?", "Pure Atari soul."],
  ["Chip or sample?", "Chip first."],
  ["Pattern 00?", "Pattern go!"],
  ["Pattern break?", "Pattern beer."],
  ["Loop?", "Forever loop."],
  ["Sync?", "Perfect sync."],
  ["Desync?", "Party mode."],
  ["Fullscreen?", "Full goose."],
  ["Copper glitch?", "Artistic choice."],
  ["Raster timing?", "Pixel-perfect."],
  ["IRQ storm?", "Ride it."],
  ["SID filter?", "Warm and wobbly."],
  ["Tracker open?", "Patterns waiting."],
  ["Sample rate?", "Low but mighty."],
  ["Dithering?", "Always dithering."],
  ["Palette?", "16 colors of destiny."],
  ["Copper rainbow?", "Taste the rainbow."],
  ["Plasma?", "Smooth as butter."],
  ["Tunnel?", "Infinite tunnel."],
  ["Voxel?", "Fake but fabulous."],
  ["Bumpmap?", "Bumpy goose."],
  ["Lensflare?", "1999 approved."],
  ["Logo?", "Shiny and beveled."],
  ["Intro?", "64k or bust."],
  ["Megademo?", "Mega-quack."],
  ["Going to The Party?", "Bring warm feathers."],
  ["Assembly?", "Legendary halls."],
  ["Breakpoint?", "Beer and brilliance."],
  ["Revision?", "Easter magic."],
  ["Evoke?", "Cologne vibes."],
  ["Datastorm?", "Swedish retro heaven."],
  ["X Party?", "C64 elite."],
  ["Outline?", "Forest coding."],
  ["Solskogen?", "Norwegian sunshine."],
  ["Function?", "Hungarian chaos."],
  ["Demobit?", "Slovakian style."],
  ["Nordlicht?", "Northern lights and bytes."],
  ["Compusphere?", "Swedish nostalgia."],
  ["TRSAC?", "Danish madness."],
  ["Jevnaker?", "Retro warmth."],
  ["Hackerence?", "Finnish winter coding."],
  ["Buenzli?", "Swiss charm."],
  ["Flashparty?", "Argentina hype."],
  ["Syntax?", "Aussie scene!"],
  ["Inércia?", "Portuguese passion."],
  ["Compofiller?", "Always needed."],
  ["Compo deadline?", "Ignored."],
  ["Compo delay?", "Guaranteed."],
  ["Compo beer?", "Mandatory."],
  ["Sleeping hall?", "No sleep."],
  ["Couch area?", "Coder nest."],
  ["Bigscreen?", "Goose-sized."],
  ["Beamteam?", "Heroes."],
  ["Prizegiving?", "Awkward applause."],
  ["Afterparty?", "Always."],
  ["Beforeparty?", "Also always."],
  ["Bus to party?", "Packed with nerds."],
  ["Train to party?", "Tracking on headphones."],
  ["Car to party?", "SID blasting."],
  ["LAN noise?", "Comforting."],
  ["Pizza smell?", "Traditional."],
  ["Energy drinks?", "Coder fuel."],
  ["Sleeping bag?", "Unused."],
  ["Shower?", "Optional."],
  ["Voting?", "Strategic."],
  ["Trolling?", "Friendly."],
  ...
  ["Last-minute fix?", "Breaks everything."],
  ["Emergency build?", "Works once."],
  ["Compo hype?", "Maximum."],
  ["Compo crash?", "Legendary."],
  ["Compo winner?", "Unexpected."],
  ["Compo goose?", "Honks in victory."],
];
...
export const __testing = {
  ...
  getOnelinerDialoguesForTests: () => ONELINER_DIALOGUES.map((dialogue) => [...dialogue]),
